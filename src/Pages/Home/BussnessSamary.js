...
const BussnessSamary = () => {
    return (
        <div data-aos="flip-right" data-aos-duration="2000">
            <div className="stats shadow lg:w-10/12 my-14 mx-auto grid grid-cols-1 lg:grid-cols-3">

                <div data-aos="flip-right" className="stat bg-warning p-10">
                ...
                <div data-aos="flip-right" className="stat bg-accent p-10">
                ...
                <div className="stat bg-orange-600 p-10">
